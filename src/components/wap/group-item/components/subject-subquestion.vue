...
export default {
    ...
    subQuestionProps () {
      if (this.tempMap === 'analysis-item') {
        return {
          ...
          controlShowPictureAnswer: this.controlShowPictureAnswer,
  ...
  render (h) {
    ...
    return (
      <div><tempMap { ...{ props: this.subQuestionProps }} {...{ on: this.subQuestionEvent }}>
        {extraSlotStatus}{extraSlotBottom}{analysisSlotQuestionBottom}</tempMap></div>
    )
  }
}
</script>
